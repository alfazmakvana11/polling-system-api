...
module.exports.create = async function(req, res) {
    ...
    // Log the ID of the newly created Option
    console.log("Newly created Option ID:", opt._id);
...
module.exports.add_vote = async function(req, res) {
    ...
    if(opt){
        ...
        // Log the ID of the updated Option
...
module.exports.delete = async function(req, res) {
    ...
    if (opt) {
        ...
        // Log the ID of the deleted Option
        console.log("Deleted Option ID:", opt._id);

        console.log(ques);
        res.json({ message: "Option deleted successfully" }); // Return a JSON response
    } else {
        res.status(404).json({ message: "Option not found" }); // Return a 404 Not Found status
    }
}
